                ...
                link: function(scope, element, attrs) {
                    ...
                    on_treeData_change = function() {
                        ...
                        add_branch_to_list = function(level, branch, visible) {
                            ...
                            ///Modificacion en directiva para obtener el icono y el color segun el atributo
                            if (branch.icono!=undefined) {
                                tree_icon = branch.icono;
                            }else if (branch.nivel!=undefined){
                                tree_icon = branch.nivel.iconoCss;
                            }else {
                            ...
                            var simbolo = branch.children.length>0 ? '+' : '-';
                            scope.tree_rows.push({
                                level: level,
                                branch: branch,
                                label:  simbolo +' ' +branch.label,
                                tree_icon: tree_icon,
                                visible: visible
                            });
                            if (branch.children != null) {
