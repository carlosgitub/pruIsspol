...
/**
 * RastroDetalleId generated by hbm2java
 */
@Embeddable
public class RastroDetalleId implements java.io.Serializable {

	private Integer idRastro;
	private Integer idColumna;

	public RastroDetalleId() {
	}

	public RastroDetalleId(Integer idRastro, Integer idColumna) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RastroDetalleId))
			return false;
		RastroDetalleId castOther = (RastroDetalleId) other;
